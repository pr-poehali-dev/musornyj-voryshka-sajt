  ...
  const tariffs = [
    {
      ...
      emoji: "🗑️",
      description:
        "Для тех, кто живет сам и ненавидит выносить мусор. Вы целеустремленная личность. Много учитесь, работаете или время проводите за просмотром сериалов. Еноту не важно, с пользой вы проводите время или нет. Он вас не осудит, просто сделает свою работу. Выносим мусор 8 раз в месяц",
      features: [],
      popular: false,
    },
    {
