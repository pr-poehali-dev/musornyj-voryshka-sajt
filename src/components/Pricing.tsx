  ...
  const tariffs = [
    {
      ...
      description: (
        <>
          ...
          <br />
          <br />
          Вы целеустремленная личность. Много учитесь, работаете или время
          проводите за просмотром сериалов. Еноту не важно, с пользой вы
          проводите время или нет. Он вас не осудит, просто сделает свою работу.
          <br />
          <br />
