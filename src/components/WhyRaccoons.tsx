  ...
  const reasons = [
    {
      ...
      description:
        "Еноты от природы очень внимательны к деталям и не упустят ни одного мешка",
    },
    {
      emoji: "🌙",
      title: "Работаем в любое время",
      description:
        "Еноты активны и днём, и вечером - вывозим мусор когда удобно вам",
    },
    {
      emoji: "🧼",
